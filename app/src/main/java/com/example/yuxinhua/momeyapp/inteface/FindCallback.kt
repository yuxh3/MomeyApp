 ...
 */
class FindCallback : DiffUtil.Callback {

    private var mOldDatas:ArrayList<FindData>? = null
    private var mNewData:ArrayList<FindData>? = null

    constructor(mOldDatas: ArrayList<FindData>?, mNewData: ArrayList<FindData>?) : super() {
